...
import 'package:flutter_quill/src/widgets/magic_widget/toggleable.dart';
...
class _CheckboxState extends State<MagicCheckbox> with TickerProviderStateMixin, MagicToggleableStateMixin {
  ...
  @override
  void didUpdateWidget(MagicCheckbox oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    Size size = const Size(kMinInteractiveDimension, kMinInteractiveDimension);

    // Colors need to be resolved in selected and non selected states separately
    // so that they can be lerped between.
    final Set<MaterialState> activeStates = states..add(MaterialState.selected);
    final Set<MaterialState> inactiveStates = states..remove(MaterialState.selected);
    final Color effectiveActiveColor = CupertinoColors.activeGreen;
    final Color effectiveInactiveColor = CupertinoColors.inactiveGray;

    final Color effectiveCheckColor = CupertinoColors.white;
...
class _CheckboxPainter extends MagicToggleablePainter {
